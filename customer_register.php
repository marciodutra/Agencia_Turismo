...
if (isset($_POST['register'])) {
    ...
    if ($check_cart == 0) {
        ...
        echo "<script>alert('A conta foi criada com sucesso. Obrigado!')</script>";
...
<head>
    <meta charset="UTF-8">
    <title>Travel Bird : Registro</title>
        ...
        <div class="content_wrapper">
            ...
            <div id="content_area">
                ...
                <div id="shopping_cart">
                        <span style="float: right;font-size: 18px;padding: 5px;line-height: 40px;">Bem vindo convidado! <b
                                    style="color: yellow;">Carrinho de compras-</b> Total de Itens: <?php total_items(); ?> Preço total: <?php total_price(); ?> <a
                ...
                <form action="customer_register.php" method="post" enctype="multipart/form-data">
                    <table align="center" width="750" style="margin-top: 20px;">
                        <tr align="center">
                            <td colspan="6">
                                <h2 style="margin-bottom: 15px; font-family: Cambria;">Crie a sua conta aqui</h2>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" id="fixm">Seu nome:</td>
                            <td><input id="fixi" type="text" name="c_name" required=""></td>
                        </tr>
                        <tr>
                            <td align="right" id="fixm">Seu email:</td>
                            <td><input type="email" name="c_email" required=""></td>
                        </tr>
                        <tr>
                            <td align="right" id="fixm">Sua senha:</td>
                            <td><input id="fixi" type="password" name="c_pass" required=""></td>
                        </tr>
                        <tr>
                            <td align="right" id="fixm">Seu ID de passaporte:</td>
                            <td><input type="text" name="c_passport" required=""></td>
                        </tr>
                        <tr>
                            <td align="right" id="fixm">Sua imagem:</td>
                            <td><input id="fixi" type="file" name="c_image" required=""></td>
                        </tr>
                        <tr>
                            <td align="right" id="fixm">Seu país:</td>
                            <td>
                                <select name="c_country" required="">Selecione uma
                        ...
                        <tr>
                            <td align="right" id="fixm">Sua cidade:</td>
                            <td><input id="fixi" type="text" name="c_city" required=""></td>
                        </tr>
                        <tr>
                            <td align="right" id="fixm">Seu contato:</td>
                            <td><input id="fixi" type="text" name="c_contact" required=""></td>
                        </tr>
                        <tr>
                            <td align="right" id="fixm">Seu endereço:</td>
                            <td><input id="fixi" type="text" name="c_address" required=""></td>
                        </tr>
                        <tr align="center">
                            <td colspan="6"><input id="btn" type="submit" name="register" value="Criar uma conta">
                            </td>
                        </tr>
                    </table>
                </form>
