...
<head>
    <meta charset="UTF-8">
    <title>Travel Bird : Carrrinho</title>
                ...
                <div id="shopping_cart">
                    <span style="float: right;font-size: 18px;padding: 5px;line-height: 40px;">
                        ...
                        if (isset($_SESSION['customer_email'])) {
                            echo "<b>Welcome: </b>" . $_SESSION['customer_email'] . "<b style='color: yellow;'> Seu</b>";
                        } else {
                            echo "<b>Bem vindo convidado:</b>";
                        }
                        ?>
                        <b style="color: yellow;">Carrinho de compras-</b> Total de Itens: <?php total_items(); ?>
                        Preço total: <?php total_price(); ?>
                        <a href="index.php" style="color: yellow;">Voltar à loja</a>
                        <?php
                        if (!isset($_SESSION['customer_email'])) {
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <table align="center" width="700px" bgcolor="skyblue">
                            ...
                            <tr align="center">
                                ...
                                <td><input type="submit" name="continue" value="Continue comprando"></td>
                                <td>
