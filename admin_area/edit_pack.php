...
<body bgcolor="skyblue">
    <form action="" method="post" enctype="multipart/form-data">
        <table align="center" width="795" border=2px bgcolor="ABB3C8">
            <tr align="center">
                <td colspan="7"><h2 style="font-family: Cambria; margin-top: 20px; margin-bottom: 15px;">Editar e Alterar
                                                                                                         Pacote</h2>
                </td>
            </tr>
            <tr>
            ...
            <tr align="center">
                <td colspan="7"><input style="margin-top: 10px; margin-bottom: 15px;" type="submit"
                                       name="update_package" value="Alterar pacote"></td>
            </tr>
        </table>
    </form>
</body>
...
if (isset($_POST['update_package'])) {
    ...
    if ($run_pack) {
        echo "<script>alert('O pacote foi ATUALIZADO com sucesso!')</script>";
