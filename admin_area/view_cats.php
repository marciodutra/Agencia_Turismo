...
if (!isset($_SESSION['user_email'])) {
    ...
    <body>
        <table width="795" align="center" bgcolor="#EAD2AC">
            <tr align="center">
                <td colspan="6"><h2 style="font-family: Cambria; margin-top: 10px; margin-bottom: 5px;">Ver todas
                                                                                                        Categorias
                                                                                                        aqui</h2></td>
            </tr>
            <tr align="center" bgcolor="#5FCEE8">
                <th id="thfix">ID Categoria</th>
            ...
            while ($row_cat = mysqli_fetch_array($run_cat)) {
                ...
                <tr align="center">
                    ...
                    <td><a href="index.php?edit_cat=<?php echo $cat_id; ?>">Edite</a></td>
