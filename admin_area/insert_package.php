...
if (isset($_POST['insert_post'])) {
    ...
    if ($insert_pack) {
        echo "<script>alert('O pacote foi inserido!')</script>";
...
<body bgcolor="skyblue">
    <form action="insert_package.php" method="post" enctype="multipart/form-data">
        <table align="center" width="795" border=2px bgcolor="ABB3C8">
            <tr align="center">
                <td colspan="7"><h2 style="font-family: Cambria;margin-top: 20px; margin-bottom: 15px;">Insere novo
                                                                                                        pacote
                                                                                                        aqui</h2>
                </td>
            </tr>
            <tr>
                <td align="right"><b>Título do pacote:</b></td>
                <td><input type="text" name="package_title" size="60"></td>
            </tr>
            <tr>
                <td align="right"><b>Categoria do pacote:</b></td>
                <td>
            ...
            <tr>
                <td align="right"><b>Tipo de pacote:</b></td>
                <td>
            ...
            <tr align="center">
                <td colspan="7"><input style="margin-top: 10px; margin-bottom: 15px;" type="submit"
                                       name="insert_post" value="Inserir pacote"></td>
            </tr>
        </table>
    </form>
</body>
