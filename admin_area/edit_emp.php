...
if (isset($_POST['update_employee'])) {
    ...
    if ($run_pack) {
        echo "<script>alert('Um funcionário foi ATUALIZADO com sucesso!')</script>";
    ...
    if (isset($_GET['edit_emp'])) {
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <table align="center" width="795" border=2px bgcolor="ABB3C8">
                <tr align="center">
                    <td colspan="7"><h2 style="font-family: Cambria;margin-top: 20px; margin-bottom: 15px;">Inserir novo
                                                                                                            funcionário</h2>
                    </td>
                </tr>
                <tr>
                ...
                <tr align="center">
                    <td colspan="7"><input style="margin-top: 10px; margin-bottom: 15px;" type="submit"
                                           name="update_employee" value="Atualizar Funcionário"></td>
                </tr>
            </table>
        </form>
        <?php
