...
if (!isset($_SESSION['user_email'])) {
    ...
    <body>
        <form action="" method="post" style="padding: 80px;">
            <table align="center">
                <tr>
                    <td align="left"><b>Inserir novo tipo:</b></td>
                ...
                <tr>
                    <td></td>
                    <td align="right"><input id="btn" type="submit" name="add_type" value="Adicionar tipo"></td>
                </tr>
            </table>
        </form>
        <?php
        ...
        if (isset($_POST['add_type'])) {
            ...
            if ($run_type) {
                echo "<script>alert('O novo tipo foi INSERIDO com sucesso!')</script>";
