...
if (!isset($_SESSION['user_email'])) {
    ...
    <body>
        <form action="" method="post" style="padding: 80px;">
            <table align="center">
                <tr>
                    <td align="left"><b>Alterar tipo:</b></td>
                ...
                <tr>
                    <td></td>
                    <td align="right"><input id="btn" type="submit" name="update_type" value="Alterar tipo"></td>
                </tr>
            </table>
        </form>
        <?php
        ...
        if (isset($_POST['update_type'])) {
            ...
            if ($run_type) {
                echo "<script>alert('tipo foi ATUALIZADO com sucesso!')</script>";
