...
<head>
    <meta charset="UTF-8">
    <title>Travel Bird : Detalhes</title>
            ...
            <div id="content_area">
                <div id="shopping_cart">
                    <span style="float: right;font-size: 18px;padding: 5px;line-height: 40px;">Bem vindo convidado! <b
                                style="color: yellow;">Carrinho de compras-</b> Total de itens: Preço total: <a href="cart.php"  style="color: yellow;">Ir para o carrinho</a></b></span>
                </div>
                <div id="packages_box">
                    <?php
                    if (isset($_GET['pack_id'])) {
                        ...
                        while ($row_pack = mysqli_fetch_array($run_pack)) {
                            ...
                            <p>$pack_desc</p>
                            <a href='index.php' style='float: left; font-size: 18px;'>Volte</a>
                            <a href='index.php?pack_id=$pack_id'><button style='float: right;font-size:16px; cursor: pointer; padding: 2px 4px; margin:2px;'>Livro</button></a>
                            </div>
                            ";
                        }
                    }
