...
<head>
    <meta charset="UTF-8">
    <title>Itens de Viagem: Resultados</title>
                ...
                <div id="packages_box">
                    ...
                    if (isset($_GET['search'])) {
                        ...
                        while ($row_pack = mysqli_fetch_array($run_pack)) {
                            ...
                            <p><b> $ $pack_price</b></p>
                            <a href='details.php?pack_id=$pack_id' style='float: left;'>Detalhes</a>
                            <a href='index.php?pack_id=$pack_id'><button style='float: right;'>Livro</button></a>
                            </div>
                            ";
                        }
                    }
